-- RETRO-AUDIT R3, taken as an import: the Warlock (Air and Fire).
--
-- One-off data script, run once per environment. NOT a migration.
--
--   node scripts/d1-apply.mjs --local  apps/character-creator/db/add-warlock-air-fire-class.sql
--   node scripts/d1-apply.mjs --remote apps/character-creator/db/add-warlock-air-fire-class.sql
--
...
SELECT 'warlock-air-fire', 'Warlock (Air and Fire)', 'rifts', '---
id: warlock-air-fire
occ_group: magic
name: Warlock
system: rifts
...
magic:
  ...
  spells_starting_groups:
    - { count: 1, from: ["Air: Breathe Without Air", "Air: Cloud of Slumber", "Air: Cloud of Steam", "Air: Create Light", "Air: Create Mild Wind", "Air: Stop Wind", "Air: Thunderclap"], note: "One Air spell at first level." }
  ...
  spell_lists:
    air_L1: ["Air: Breathe Without Air", "Air: Cloud of Slumber", "Air: Cloud of Steam", "Air: Create Light", "Air: Create Mild Wind", "Air: Stop Wind", "Air: Thunderclap"]
  ...
  spells_schedule:
    - { level: 2, count: 1, from_list: "air_L2" }
    - { level: 2, count: 1, from_list: "fire_L2" }
    - { level: 3, count: 1, from_list: "air_L3" }
    - { level: 3, count: 1, from_list: "fire_L3" }
    - { level: 4, count: 1, from_list: "air_L4" }
    - { level: 4, count: 1, from_list: "fire_L4" }
    - { level: 5, count: 1, from_list: "air_L5" }
    - { level: 5, count: 1, from_list: "fire_L5" }
    - { level: 6, count: 1, from_list: "air_L6" }
    - { level: 6, count: 1, from_list: "fire_L6" }
    - { level: 7, count: 1, from_list: "air_L7" }
    - { level: 7, count: 1, from_list: "fire_L7" }
    - { level: 8, count: 1, from_list: "air_L8" }
    - { level: 8, count: 1, from_list: "fire_L8" }
    - { level: 9, count: 1, from_list: "air_L8" }
    - { level: 9, count: 1, from_list: "fire_L8" }
    - { level: 10, count: 1, from_list: "air_L8" }
    - { level: 10, count: 1, from_list: "fire_L8" }
    - { level: 11, count: 1, from_list: "air_L8" }
    - { level: 11, count: 1, from_list: "fire_L8" }
    - { level: 12, count: 1, from_list: "air_L8" }
    - { level: 12, count: 1, from_list: "fire_L8" }
    - { level: 13, count: 1, from_list: "air_L8" }
    - { level: 13, count: 1, from_list: "fire_L8" }
    - { level: 14, count: 1, from_list: "air_L8" }
    - { level: 14, count: 1, from_list: "fire_L8" }
    - { level: 15, count: 1, from_list: "air_L8" }
...
', 'published', 'retro-audit-r3'
 WHERE NOT EXISTS (SELECT 1 FROM imported_classes WHERE class_id = 'warlock-air-fire');

SELECT 'warlock-air-fire is published' AS assertion, count(*) AS got, 1 AS want
  FROM imported_classes WHERE class_id = 'warlock-air-fire' AND status = 'published' AND deleted_at IS NULL;

INSERT INTO data_script_runs (filename) VALUES ('add-warlock-air-fire-class.sql');
