-- RETRO-AUDIT R3, taken as an import: the Warlock (Air and Water).
--
-- One-off data script, run once per environment. NOT a migration.
--
--   node scripts/d1-apply.mjs --local  apps/character-creator/db/add-warlock-air-water-class.sql
--   node scripts/d1-apply.mjs --remote apps/character-creator/db/add-warlock-air-water-class.sql
--
...
SELECT 'warlock-air-water', 'Warlock (Air and Water)', 'rifts', '---
id: warlock-air-water
occ_group: magic
name: Warlock
system: rifts
...
', 'published', 'retro-audit-r3'
 WHERE NOT EXISTS (SELECT 1 FROM imported_classes WHERE class_id = 'warlock-air-water');

SELECT 'warlock-air-water is published' AS assertion, count(*) AS got, 1 AS want
  FROM imported_classes WHERE class_id = 'warlock-air-water' AND status = 'published' AND deleted_at IS NULL;

INSERT INTO data_script_runs (filename) VALUES ('add-warlock-air-water-class.sql');
