-- Chiang-Ku hatchling skill overrides, now that a variant can restate a
-- percentage on a skill the class already grants.
--
-- Dragons and Gods p.23: "Hatchlings start with the language and basic math
-- skills at 96% proficiency. Domestic skills, advanced math and all other
-- skills start at first level proficiency."
--
-- The class held everything at the adult's numbers, so a hatchling knew
-- advanced math at 96% and every domestic skill at 80% when the book gives it
-- those at the catalog base.
--
