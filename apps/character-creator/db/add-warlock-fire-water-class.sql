-- RETRO-AUDIT R3, taken as an import: the Warlock (Fire and Water).
--
-- One-off data script, run once per environment. NOT a migration.
--
--   node scripts/d1-apply.mjs --local  apps/character-creator/db/add-warlock-fire-water-class.sql
--   node scripts/d1-apply.mjs --remote apps/character-creator/db/add-warlock-fire-water-class.sql
--
...
-- Magic ability:
--   TWO spell selections per level, one from EACH sphere - not three from one.
--   The book: "the character only gets two spell selections per level of
--   experience, instead of three; one from each of his two Elements." Needs
--   I.Q. 12 and M.E. 14, which this class states as attribute_requirements.
--
...
SELECT 'warlock-fire-water', 'Warlock (Fire and Water)', 'rifts', '---
id: warlock-fire-water
occ_group: magic
name: Warlock
system: rifts
...
ppe_base: "2d4x10+40 plus P.E. attribute number, +2d6 per additional level of experience"
starting_money: "2d6x1000"
magic:
  type: "elemental"
  # TWO spell selections per level, one from EACH sphere - not three from one.
  # Conversion Book One printed 67: "the character only gets two spell
  # selections per level of experience, instead of three; one from each of his
  # two Elements." RETRO-AUDIT R3.
  spells_starting: 2
  spells_starting_groups:
    - { count: 1, from: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades"], note: "One Fire spell at first level." }
    - { count: 1, from: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine"], note: "One Water spell at first level." }
  spell_lists:
    fire_L1: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades"]
    fire_L2: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame"]
    fire_L3: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame", "Fire: Circle of Cold", "Fire: Circle of Flame", "Fire: Create Heat", "Fire: Extinguish Fire", "Fire: Fire Ball", "Fire: Fire Gout", "Fire: Lower Temperature", "Fire: Part Fire", "Fire: Wall of Flame"]
    fire_L4: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame", "Fire: Circle of Cold", "Fire: Circle of Flame", "Fire: Create Heat", "Fire: Extinguish Fire", "Fire: Fire Ball", "Fire: Fire Gout", "Fire: Lower Temperature", "Fire: Part Fire", "Fire: Wall of Flame", "Fire: Cloud of Steam", "Fire: Fire Blossom", "Fire: Flame Friend", "Fire: Fuel Flame", "Fire: Heal Burns", "Fire: Mini-Fireballs", "Fire: See Through Smoke"]
    fire_L5: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame", "Fire: Circle of Cold", "Fire: Circle of Flame", "Fire: Create Heat", "Fire: Extinguish Fire", "Fire: Fire Ball", "Fire: Fire Gout", "Fire: Lower Temperature", "Fire: Part Fire", "Fire: Wall of Flame", "Fire: Cloud of Steam", "Fire: Fire Blossom", "Fire: Flame Friend", "Fire: Fuel Flame", "Fire: Heal Burns", "Fire: Mini-Fireballs", "Fire: See Through Smoke", "Fire: Blue Flame", "Fire: Breathe Fire", "Fire: Eat Fire", "Fire: Fire Globe", "Fire: Screaming Wall of Flame", "Fire: Wall of Ice"]
    fire_L6: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame", "Fire: Circle of Cold", "Fire: Circle of Flame", "Fire: Create Heat", "Fire: Extinguish Fire", "Fire: Fire Ball", "Fire: Fire Gout", "Fire: Lower Temperature", "Fire: Part Fire", "Fire: Wall of Flame", "Fire: Cloud of Steam", "Fire: Fire Blossom", "Fire: Flame Friend", "Fire: Fuel Flame", "Fire: Heal Burns", "Fire: Mini-Fireballs", "Fire: See Through Smoke", "Fire: Blue Flame", "Fire: Breathe Fire", "Fire: Eat Fire", "Fire: Fire Globe", "Fire: Screaming Wall of Flame", "Fire: Wall of Ice", "Fire: Dancing Fires", "Fire: Eternal Flame", "Fire: Fire Whip", "Fire: Flame of Life"]
    fire_L7: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame", "Fire: Circle of Cold", "Fire: Circle of Flame", "Fire: Create Heat", "Fire: Extinguish Fire", "Fire: Fire Ball", "Fire: Fire Gout", "Fire: Lower Temperature", "Fire: Part Fire", "Fire: Wall of Flame", "Fire: Cloud of Steam", "Fire: Fire Blossom", "Fire: Flame Friend", "Fire: Fuel Flame", "Fire: Heal Burns", "Fire: Mini-Fireballs", "Fire: See Through Smoke", "Fire: Blue Flame", "Fire: Breathe Fire", "Fire: Eat Fire", "Fire: Fire Globe", "Fire: Screaming Wall of Flame", "Fire: Wall of Ice", "Fire: Dancing Fires", "Fire: Eternal Flame", "Fire: Fire Whip", "Fire: Flame of Life", "Fire: Fire Sponge", "Fire: Melt Metal", "Fire: River of Lava", "Fire: Ten Foot Wheel of Fire"]
    fire_L8: ["Fire: Blinding Flash", "Fire: Cloud of Smoke", "Fire: Create Coal", "Fire: Fiery Touch", "Fire: Fire Bolt", "Fire: Globe of Daylight", "Fire: Impervious to Fire", "Fire: Nightvision", "Fire: Stench of Hades", "Fire: Cloud of Ash", "Fire: Darkness", "Fire: Fireblast", "Fire: Flame Lick", "Fire: Freeze Water", "Fire: Heat Object/Boil Water", "Fire: Resist Cold", "Fire: Spontaneous Combustion", "Fire: Swirling Lights", "Fire: Tongue of Flame", "Fire: Circle of Cold", "Fire: Circle of Flame", "Fire: Create Heat", "Fire: Extinguish Fire", "Fire: Fire Ball", "Fire: Fire Gout", "Fire: Lower Temperature", "Fire: Part Fire", "Fire: Wall of Flame", "Fire: Cloud of Steam", "Fire: Fire Blossom", "Fire: Flame Friend", "Fire: Fuel Flame", "Fire: Heal Burns", "Fire: Mini-Fireballs", "Fire: See Through Smoke", "Fire: Blue Flame", "Fire: Breathe Fire", "Fire: Eat Fire", "Fire: Fire Globe", "Fire: Screaming Wall of Flame", "Fire: Wall of Ice", "Fire: Dancing Fires", "Fire: Eternal Flame", "Fire: Fire Whip", "Fire: Flame of Life", "Fire: Fire Sponge", "Fire: Melt Metal", "Fire: River of Lava", "Fire: Ten Foot Wheel of Fire", "Fire: Burst into Flame", "Fire: Drought", "Fire: Plasma Bolt"]
    water_L1: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine"]
    water_L2: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal"]
    water_L3: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal", "Water: Calm Waters", "Water: Circle of Rain", "Water: Command Fish", "Water: Freeze Water", "Water: Impervious to Ocean Depth", "Water: Resist Cold", "Water: Sheet of Ice"]
    water_L4: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal", "Water: Calm Waters", "Water: Circle of Rain", "Water: Command Fish", "Water: Freeze Water", "Water: Impervious to Ocean Depth", "Water: Resist Cold", "Water: Sheet of Ice", "Water: Communicate with Sea Creature", "Water: Create Water", "Water: Hail", "Water: Shards of Ice", "Water: Speak Underwater", "Water: Swim Like the Dolphin", "Water: Wall of Ice", "Water: Water Wisps"]
    water_L5: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal", "Water: Calm Waters", "Water: Circle of Rain", "Water: Command Fish", "Water: Freeze Water", "Water: Impervious to Ocean Depth", "Water: Resist Cold", "Water: Sheet of Ice", "Water: Communicate with Sea Creature", "Water: Create Water", "Water: Hail", "Water: Shards of Ice", "Water: Speak Underwater", "Water: Swim Like the Dolphin", "Water: Wall of Ice", "Water: Water Wisps", "Water: Earth to Mud", "Water: Protection from Lightning", "Water: Snow Storm", "Water: Ten Foot Ball of Ice", "Water: Whirlpool"]
    water_L6: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal", "Water: Calm Waters", "Water: Circle of Rain", "Water: Command Fish", "Water: Freeze Water", "Water: Impervious to Ocean Depth", "Water: Resist Cold", "Water: Sheet of Ice", "Water: Communicate with Sea Creature", "Water: Create Water", "Water: Hail", "Water: Shards of Ice", "Water: Speak Underwater", "Water: Swim Like the Dolphin", "Water: Wall of Ice", "Water: Water Wisps", "Water: Earth to Mud", "Water: Protection from Lightning", "Water: Snow Storm", "Water: Ten Foot Ball of Ice", "Water: Whirlpool", "Water: Encase in Ice", "Water: Heal Burns", "Water: Hurricane", "Water: Little Ice Monster", "Water: Part Waters", "Water: Summon Sharks or Whales"]
    water_L7: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal", "Water: Calm Waters", "Water: Circle of Rain", "Water: Command Fish", "Water: Freeze Water", "Water: Impervious to Ocean Depth", "Water: Resist Cold", "Water: Sheet of Ice", "Water: Communicate with Sea Creature", "Water: Create Water", "Water: Hail", "Water: Shards of Ice", "Water: Speak Underwater", "Water: Swim Like the Dolphin", "Water: Wall of Ice", "Water: Water Wisps", "Water: Earth to Mud", "Water: Protection from Lightning", "Water: Snow Storm", "Water: Ten Foot Ball of Ice", "Water: Whirlpool", "Water: Encase in Ice", "Water: Heal Burns", "Water: Hurricane", "Water: Little Ice Monster", "Water: Part Waters", "Water: Summon Sharks or Whales", "Water: Drought", "Water: Rain Dance", "Water: Summon Storm"]
    water_L8: ["Water: Cloud of Steam", "Water: Color Water", "Water: Create Fog", "Water: Dowsing", "Water: Float on Water", "Water: Purple Mist", "Water: Salt Water to Fresh", "Water: Sense Direction Underwater", "Water: Walk the Waves", "Water: Water to Wine", "Water: Breathe Underwater", "Water: Change Current", "Water: Fog of Fear", "Water: Foul Water", "Water: Frostblade", "Water: Liquids to Water", "Water: Resist Fire", "Water: Ride the Waves", "Water: Swim as a Fish: Superior", "Water: Water Seal", "Water: Calm Waters", "Water: Circle of Rain", "Water: Command Fish", "Water: Freeze Water", "Water: Impervious to Ocean Depth", "Water: Resist Cold", "Water: Sheet of Ice", "Water: Communicate with Sea Creature", "Water: Create Water", "Water: Hail", "Water: Shards of Ice", "Water: Speak Underwater", "Water: Swim Like the Dolphin", "Water: Wall of Ice", "Water: Water Wisps", "Water: Earth to Mud", "Water: Protection from Lightning", "Water: Snow Storm", "Water: Ten Foot Ball of Ice", "Water: Whirlpool", "Water: Encase in Ice", "Water: Heal Burns", "Water: Hurricane", "Water: Little Ice Monster", "Water: Part Waters", "Water: Summon Sharks or Whales", "Water: Drought", "Water: Rain Dance", "Water: Summon Storm", "Water: Calm Waters (greater)", "Water: Creature of the Waves", "Water: Tidal Wave"]
  # Two entries at each level, one per sphere. `slot` is derived by POSITION,
  # so nothing states it by hand - the Ley Line Rifter shape.
  spells_schedule:
    - { level: 2, count: 1, from_list: "fire_L2" }
    - { level: 2, count: 1, from_list: "water_L2" }
    - { level: 3, count: 1, from_list: "fire_L3" }
    - { level: 3, count: 1, from_list: "water_L3" }
    - { level: 4, count: 1, from_list: "fire_L4" }
    - { level: 4, count: 1, from_list: "water_L4" }
    - { level: 5, count: 1, from_list: "fire_L5" }
    - { level: 5, count: 1, from_list: "water_L5" }
    - { level: 6, count: 1, from_list: "fire_L6" }
    - { level: 6, count: 1, from_list: "water_L6" }
    - { level: 7, count: 1, from_list: "fire_L7" }
    - { level: 7, count: 1, from_list: "water_L7" }
    - { level: 8, count: 1, from_list: "fire_L8" }
    - { level: 8, count: 1, from_list: "water_L8" }
    - { level: 9, count: 1, from_list: "fire_L8" }
    - { level: 9, count: 1, from_list: "water_L8" }
    - { level: 10, count: 1, from_list: "fire_L8" }
    - { level: 10, count: 1, from_list: "water_L8" }
    - { level: 11, count: 1, from_list: "fire_L8" }
    - { level: 11, count: 1, from_list: "water_L8" }
    - { level: 12, count: 1, from_list: "fire_L8" }
    - { level: 12, count: 1, from_list: "water_L8" }
    - { level: 13, count: 1, from_list: "fire_L8" }
    - { level: 13, count: 1, from_list: "water_L8" }
    - { level: 14, count: 1, from_list: "fire_L8" }
    - { level: 14, count: 1, from_list: "water_L8" }
    - { level: 15, count: 1, from_list: "fire_L8" }
    - { level: 15, count: 1, from_list: "water_L8" }
bonuses:
...
', 'published', 'retro-audit-r3'
 WHERE NOT EXISTS (SELECT 1 FROM imported_classes WHERE class_id = 'warlock-fire-water');

SELECT 'warlock-fire-water is published' AS assertion, count(*) AS got, 1 AS want
  FROM imported_classes WHERE class_id = 'warlock-fire-water' AND status = 'published' AND deleted_at IS NULL;

INSERT INTO data_script_runs (filename) VALUES ('add-warlock-fire-water-class.sql');
