...
**Rows citing this book:** classes 21, gear 25, vehicles 33, skills 2, notable_npcs 7, creatures 9
...
skill RUE renamed Field Armorer & Munitions Expert (40/5 in the catalog). **None of the
27 marked new is added.** The two class-special skills, Homemade Explosives and
Investigation, were added afterwards; see the ledger. A class naming Armorer grants the catalog row.
