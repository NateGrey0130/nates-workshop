...
| 2026-09-07 | [#805](https://github.com/NateGrey0130/nates-workshop/pull/805) | class batch 6 of 6: **Navy Seaman**, **Marine**, **Sea Titan**, **Salvage Expert** (206 -> **210** live classes). The Navy Seaman is this book's only MOS class, with nine specialty options. Filed `BOOK-INGEST-AUDIT` **F27**: `class-check` does not validate skill names inside an MOS option, proved with the same bogus name in two positions. Applied `--remote` before the PR. |
