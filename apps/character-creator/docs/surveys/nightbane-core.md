...
| 2026-09-17 | #PRNUM | **Follow-ups 2 of 5: the multi-characteristic rule read as 81%.** The generator (#1140) ignored 61%+ as printed (printed 92), which made Unnatural Limbs unreachable from a multi-roll; per Nate it now ignores only the multi-characteristic rows (81%+), the likely erratum. Code only. |
