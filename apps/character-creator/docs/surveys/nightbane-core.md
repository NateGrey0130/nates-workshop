...
4. **IN PROGRESS - #1135: Psychic, Sorcerer, Mystic; #1136: Doppleganger, Hunter, Ashmedai, Namtar, Snake Bird; #1138: Secondary Vampire, Wild Vampire, Wampyr, Guardian. Left: the Nightbane R.C.C., its four packages, and the Nightbane Sorcerer and Mystic, after D5's generator.** **The classes**, one batch per section, cited to the entry's own pages. The Nightbane R.C.C. and its pairings wait for D5's generator.
