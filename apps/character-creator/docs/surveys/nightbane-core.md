...
4. **IN PROGRESS - #1135: Psychic, Sorcerer, Mystic; #1136: Doppleganger, Hunter, Ashmedai, Namtar, Snake Bird.** **The classes**, one batch per section, cited to the entry's own pages. The Nightbane R.C.C. and its pairings wait for D5's generator.
