...
4. **SHIPPED - #1135, #1136, #1138 and #PRNUM: all 19 classes** (15 playable per D3, plus D2's four package O.C.C.s), the last four after D5's catalog (#1137), second body (#1139) and generator (#1140). **The classes**, one batch per section, cited to the entry's own pages.
