...
**Resolved 2026-09-07 (PR #782), and the answer is yes.** RUE names the class "Dog Boys (Coalition Dog Pack - Mutant Canines)" in its own O.C.C. list, and its contents page files *Coalition Dog Pack* as a section INSIDE the Dog Boy O.C.C. - the pack is the unit, the Dog Boy is the class. So the Gargoylite borrows `dog-boy`'s ladder, which RUE printed 295 heads "CS Grunt & Dog Boys" and shares with `coalition-grunt`. This paragraph is left as written because it was true when the survey ran, and because the reason it gives - do not assume an equivalence from two names that look alike - is the reason the check was worth running.
...
| 2026-09-07 | [#794](https://github.com/NateGrey0130/nates-workshop/pull/794) | **`BOOK-INGEST-AUDIT.md` F23(b) taken** - the NGR Robot Soldier stops being the one published O.C.C. that grants no skills at all. Printed 170 gives it three SKILL PROGRAMS: choose three categories, take every skill each allows at a flat 38%%. Thirteen are offered where the book prints fourteen lines, because *Rogue: None* is a refusal rather than an offer. Needed a prefix form in the shared category matcher - *except lore* is 14 rows and *except robot combat* is 13, nine of which this book added. No new catalog rows. Applied `--remote` before the PR. |
| 2026-09-07 | [#797](https://github.com/NateGrey0130/nates-workshop/pull/797) | **the last item carrying this book's name**: the `triax-pump-weapon` gear stub, named by the *What remains* section on 2026-09-06 and never moved. Not a duplicate merge - a GENERIC stub standing in for a choice the gear pass had already imported properly as the **TX-5 Triax Pump Pistol** and the **TX-16 Pump Rifle**. The eleven Warlock rows that offered it (ten live plus the retired generic `warlock`) now offer both real guns, since Conversion Book One printed 72 says *"automatic pistol or Triax pump weapon"* and names neither model. Stub retired behind a redirect. Gear-stub backlog **7 -> 6**; `triax` 155 -> **154 traceable / 0 other**. Applied `--remote` before the PR. |
...
**Four stubs were FILLED rather than duplicated** - the T-10, T-12 and T-13 armour suits and the TX-42 rifle, all created by the NGR class batches and cited to O.C.C. pages rather than to the chapters that stat them. The repo-wide gear-stub backlog fell from eleven to seven as a result. **THE NEXT CLAUSE USED TO READ "and none of the seven that remain is this book's", AND IT WAS FALSE.** <!-- claim-ok: quoting the false sentence this paragraph corrects -->One of the seven was `triax-pump-weapon`, cited to this book's printed 143-144 - and the *What remains* section below had already named it on 2026-09-06 and said it "should move in this book's first data PR". It did not move, and this sentence then said it did not exist. Retired 2026-09-07 in PR #797, taking the backlog to **six**.
