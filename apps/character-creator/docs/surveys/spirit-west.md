...
**Still open, and none of it this book's to fix:** `BOOK-INGEST-AUDIT` F57
(level-gated spell pools admit every tradition) and F58 (the regression
harness's local timeout). F56, the totem table, was taken on 2026-09-10.
