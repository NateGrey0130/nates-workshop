...
| 22 | [Super abilities and Talents in the codex](22-codex-powers-and-talents.md) — two more tabs; Talents travel whole, super abilities as a list whose text is fetched when a row is opened, because that one catalog is 323 KB gzipped | 20 · **both halves built** |
