...
├── codex.html / codex.js     Every spell, power, item, vessel, skill and class,
│                             with its text and stat block, for anyone. Read-only
│                             by construction — GETs only, no write path. One
...
`hp_max` NULL. One-hundred-and-sixty-one of three-hundred-and-twenty-six published classes state no hit point
