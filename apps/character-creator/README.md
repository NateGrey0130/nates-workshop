...
├── codex.html / codex.js     Every spell, power, item, vessel, skill, class and
│                             Talent, with its text and stat block, for anyone.
│                             Read-only by construction — GETs only, no write
│                             path. One section per request. See plans 20 and
│                             22 in docs/plans/
